 ...
 */
class ModoRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    */
    ...
    public function deleteById($id)
    {
        ...
        $delete=$query->delete('App:Modo','modo')
                ->where('modo.id= :modoId')
                ->setParameter('modoId',$id)
                ->getQuery()
                ->execute();
    }
}
